...
Revision ID: 974dba113957
Revises: 
Create Date: 2021-01-13 18:15:12.436942
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['company_id'], ['company.store_id'], ),
    sa.ForeignKeyConstraint(['customer_id'], ['customer.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_order_creation_date'), 'order', ['creation_date'], unique=False)
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_order_creation_date'), table_name='order')
    op.drop_table('order')
