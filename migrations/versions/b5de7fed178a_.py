...
Revision ID: b5de7fed178a
Revises: 
Create Date: 2022-03-14 11:59:34.782445
...
def upgrade():
    ...
    sa.Column('store_idfiscal', sa.String(length=20), nullable=True),
    ...
    sa.Column('confirma_retiro_note', sa.String(length=500), nullable=True),
    ...
    sa.Column('correo_mail', sa.String(length=120), nullable=True),
    ...
    sa.Column('etiqueta_generada', sa.Boolean(), nullable=True),
