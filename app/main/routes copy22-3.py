...
def gestionar_ordenes(orden_id):
    ...
    if accion == 'toReady':
        # Añadir guia entrega
        if request.form.get('metodo_envio_correo') or request.form.get('metodo_envio_guia') or request.form.get('coordinar_roundtrip') or request.form.get('metodo_envio_guia_entrega'):
            ...
            orden.metodo_envio_guia_entrega = request.form.get('metodo_envio_guia_entrega', '')
